...
def latticePlanner(ref_path,vehicle_status,current_lane):  #변경 global_valid_object삭제했음
    out_path=[]
    selected_lane=-1
    ...
    if len(ref_path.poses)>look_distance :
        ...
        lane_weight=[6,4,2,0,112,114,116] #reference path
